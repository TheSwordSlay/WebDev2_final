        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="#" class="nav-link" data-toggle="modal" data-target="#exampleModal2">
                  <i class="far fa-edit"></i>
                  <p>Tambah Tugas</p>
                </a>
              </li>              
  ...
  <!-- Modal -->
      <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <form action="<?php echo base_url()?>Dashboard/tambah_matkul" method="POST">
                <div class="form-group">
                    <label for="exampleInputEmail1">Nama Mata kuliah</label>
                    <input name="matakuliah" type="text" class="form-control" id="exampleInputEmail1">
                </div>
      ...
      <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <form action="<?php echo base_url()?>Dashboard/tambah_tugas" method="POST">
            <div class="form-group">
              <label for="exampleFormControlInput1">Nama Tugas</label>
              <input name="namatugas" type="text" class="form-control" id="exampleFormControlInput1">
            </div>
            <div class="form-group">
              ...
              <select name="matakuliah" class="form-control" id="exampleFormControlSelect1">
                <?php foreach($matakuliah as $mk) {?>
                  <option><?php echo $mk->mata_kuliah?></option>
                <?php }?>
              </select>
            </div>
            <div class="form-group">
